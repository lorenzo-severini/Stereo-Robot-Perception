...
\date{\today}
\newcommand{\professor}{Luigi Di Stefano}
\newcommand{\university}{Università di Bologna}
\newcommand{\department}{Informatica - Scienza e Ingegneria - DISI}
\newcommand{\course}{LM-32 - INGEGNERIA INFORMATICA}
